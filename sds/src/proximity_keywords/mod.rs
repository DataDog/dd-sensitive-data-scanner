...
pub use crate::proximity_keywords::included_keywords::CompiledIncludedProximityKeywords;
...
#[derive(Debug)]
pub struct ProximityKeywordsRegex<const EXCLUDED_CHARS: bool> {
...
pub fn contains_keyword_in_path(path: &str, regex: &ProximityKeywordsRegex<false>) -> bool {
